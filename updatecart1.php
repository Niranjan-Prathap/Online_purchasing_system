        ...
        if(isset($_SESSION['id']))
        {
            ...
            if ($result->num_rows > 0)
            {
                echo ("<script LANGUAGE='JavaScript'>
                        ...
                        window.location.href='https://nnnmobiles.000webhostapp.com/users/customer/cart.php';
                       </script>");
            ...
            $con->query($sql2);*/
                ...
                else
                {
                     echo "<script>
                        ...
                        window.location.href='https://nnnmobiles.000webhostapp.com/users/customer/index.php';
                      </script>";      
                }
            }
