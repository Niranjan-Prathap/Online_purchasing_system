...
<html>
    ...
    <body>
            ...
            <?php 
                $pid = $_POST['pid'];
                $query="SELECT * FROM mobiles where mid='$pid'";
            ...
            <div class="w3-container w3-blue">
                ...
                <div class="w3-row-padding w3-padding-16 w3-white" style="margin:auto;width:90%">
                    ...
                    <div class="w3-container w3-twothird w3-white">
                     <h4><?php echo $rows['mname'];?></h4>
                     <input type="hidden" value="<?php echo $rows['mname'];?>" name="mname">
                     ...
                     <input type="hidden" value="<?php echo $rows['price'];?>" name="amt">
                         <div class="w3-container w3-card">
                             ...
                             <div class="w3-left">
                                 <p><b>PID:</b><?php echo $rows['mid'];?> 
                                 <input type="hidden" value="<?php echo $rows['mid'];?>" name="prodid">
                                 </p> 
                                 ...
                                 <p><b>Storage:</b> <?php echo $rows['storage'];?>
                                 <input type="hidden" value="<?php echo $rows['storage'];?>" name="storage">
                                 </p>
                             </div>
                             <div class="w3-right">
                                 <p><b>Camera:</b> <?php echo $rows['cam'];?></p>
                                 <p><b>Color:</b> <?php echo $rows['color'];?></p>
                                 <!--<p><b>Stock:</b> <?php// echo $rows['stockin'];?></p>-->
                                 <?php if($rows['stockin'] < 3) { ?>
                                 <p>Status: <span class="w3-text-red"><b>OUT OF STOCK</b></span></p>
                                 <?php } ?>
                             </div>
                         </div>
                    </div>
